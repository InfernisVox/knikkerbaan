class Particle {
  constructor(x, y) {
    ...
    this.maxAngleVel = 0.05; // Maximum angular velocity
    ...
    this.rays = [];
    let raysFor360Deg = 8000; // Concentration of rays normalized to 360 degrees
  ...
  ******************************************************************/
  ...
  // GET VELOCITIES ACCORDING TO THE DIRECTIONS
  getVelocities() {
    // Get velocity
  ...
  // GET THE NEXT POSITION ACCORDING TO THE VELOCITIES
  getNextPosition() {
    // Update direction
